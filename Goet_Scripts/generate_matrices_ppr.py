...
output_dir = "machine_learning_implementations/matrices_ppr/"
...
#import file
###############
speech_file = "raw_data/ukhcdeb_ppr.csv"
...
for x in sessions:
	...
	if x >= from_session:
		...
		iter_csv = pd.read_csv(speech_file, iterator=True, chunksize=10000)
